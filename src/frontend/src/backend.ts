...
export class Backend implements backendInterface {
    ...
    async deleteAudio(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getMyAudioFiles(): Promise<Array<AudioFile>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyAudioFiles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async renameAudio(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.renameAudio(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadAudio(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadAudio(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
